*RIDE – A Review Journal for Digital Editions and Resources* is a peer-reviewed scholarly journal whose policy is inspired by the COPE (Committee on Publication Ethics) Ethical Code (see [COPE’s Core Practices](https://publicationethics.org/core-practices) for editors, journals, publishers, and institutions). For more information on access, licensing and archiving of the articles in RIDE please see our [Publishing Policy](https://ride.i-d-e.de/publishing-policies/). We also provide Guidelines for [writing](https://ride.i-d-e.de/reviewers/writing-guidelines/) and [submitting](https://ride.i-d-e.de/reviewers/submission-guidelines/) articles for the authors.
...
Concerns and complaints must be addressed to the following e-mail [ride-editors@i-d-e.de](mailto:ride-editors@i-d-e.de). The letter should contain the following information:
...
**Stylesheet**
Authors must follow the [Writing Guidelines](https://ride.i-d-e.de/reviewers/writing-guidelines/) and [Submission Guidelines](https://ride.i-d-e.de/reviewers/submission-guidelines/) for Authors as provided on the RIDE website.
