"""Digital Text Collections questionnaire parser (criteria-text-collections)."""
...
def parse_dtc_taxonomy(taxonomy: etree._Element) -> Questionnaire:
    """Parse a Digital Text Collections taxonomy into a Questionnaire."""
...
def _parse_question(cat: etree._Element) -> QuestionnaireItem | None:
    """Parse a question category. DTC uses named IDs instead of seNNN."""
    ...
    for child in children:
        ...
        # Check for freetext via desc element
        for cd in child_descs:
